...
using JabraAssignment.Middleware;
using JabraAssignment.Repositories;
using JabraAssignment.Repositories.Interfaces;
using JabraAssignment.Services;
using JabraAssignment.Services.Interfaces;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace JabraAssignment.Extensions;
	...
	private static void LogValidationErrors(ApiBehaviorOptions options)
	{
		...
		options.InvalidModelStateResponseFactory = context =>
		{
			...
			context.HttpContext.RequestServices
				...
				.CreateLogger("JabraAssignment.Validation")
